...
TEST_CASE("testing constructor", "[CONSTRUCTOR]") {
    ...
    SECTION("when BST is empty, the root node should be set to NULL") {
...
TEST_CASE("testing insert() method on an empty BST", "[INSERT]") {
    ...
    SECTION("verify structure of BST after multiple inserts into empty BST") {
        ...
        INFO("Your BST is: " << ss.str());
        REQUIRE(tree.root != NULL);                 // checking root node
        REQUIRE(tree.root->data == 4);
        REQUIRE(tree.root->left->data == 3);        // checking node 4 children
        REQUIRE(tree.root->right->data == 5);
        REQUIRE(tree.root->left->left == NULL);     // checking node 3 children
        REQUIRE(tree.root->left->right == NULL);
        REQUIRE(tree.root->right->left == NULL);    // checking node 5 children
...
TEST_CASE("testing insert() method on a non-empty BST (multiple inserts)", "[INSERT]") {
    ...
    SECTION("verify structure of BST after inserting into a non-empty BST (multiple inserts)") {
        ...
        REQUIRE(tree.root->left->right->left == NULL);                // checking node 26 children
        ...
        REQUIRE(tree.root->right->left->left->left == NULL);          // checking node 51 children
        REQUIRE(tree.root->right->left->left->right == NULL);
        REQUIRE(tree.root->right->left->right->left == NULL);         // checking node 65 children
        REQUIRE(tree.root->right->left->right->right->data == 69);
        REQUIRE(tree.root->left->left->left->left->left == NULL);     // checking node 1 children
        REQUIRE(tree.root->left->left->left->left->right == NULL);
        REQUIRE(tree.root->left->left->left->right->left == NULL);    // checking node 6 children
        REQUIRE(tree.root->left->left->left->right->right == NULL);
        REQUIRE(tree.root->right->left->right->right->left == NULL);  // checking node 69 children
        REQUIRE(tree.root->right->left->right->right->right == NULL);
...
TEST_CASE("testing remove(x) method on an empty BST", "[REMOVE]") {
    ...
    INFO("before calling remove(x), BST should be empty [ root -> NULL ]");
    REQUIRE(tree.root == NULL);
    ...
    SECTION("verify that remove(x) doesn't break anything when BST is empty") {
        tree.remove(11);
        INFO("after calling remove(x), BST should be empty [ root -> NULL ]");
        REQUIRE(tree.root == NULL);
...
TEST_CASE("testing remove() method on a non-empty BST", "[REMOVE]") {
    ...
    SECTION("verify that remove(x) successfully removes a node that has one child (left child)") {
        ...
        REQUIRE(tree.root->left->right->left == NULL);                // checking node 26 children
        REQUIRE(tree.root->left->right->right == NULL);
        REQUIRE(tree.root->right->left->left == NULL);                // checking node 51 children
        REQUIRE(tree.root->right->left->right == NULL);
        REQUIRE(tree.root->right->right->left == NULL);               // checking node 65 children
        REQUIRE(tree.root->right->right->right->data == 69);
        REQUIRE(tree.root->left->left->left->left->data == 1);        // checking node 5 children
        REQUIRE(tree.root->left->left->left->right->data == 6);
        REQUIRE(tree.root->right->right->right->left == NULL);        // checking node 69 children
        REQUIRE(tree.root->right->right->right->right == NULL);
        REQUIRE(tree.root->left->left->left->left->left == NULL);     // checking node 1 children
        REQUIRE(tree.root->left->left->left->left->right == NULL);
        REQUIRE(tree.root->left->left->left->right->left == NULL);    // checking node 6 children
        REQUIRE(tree.root->left->left->left->right->right == NULL);
    ...
    SECTION("verify that remove(x) successfully removes a node that has one child (right child)") {
        ...
        REQUIRE(tree.root->right->left->left->left == NULL);          // checking node 51 children
        REQUIRE(tree.root->right->left->left->right == NULL);
        REQUIRE(tree.root->right->left->right->left == NULL);         // checking node 69 children
        REQUIRE(tree.root->right->left->right->right == NULL);
        REQUIRE(tree.root->left->left->left->left->left == NULL);     // checking node 1 children
        REQUIRE(tree.root->left->left->left->left->right == NULL);
        REQUIRE(tree.root->left->left->left->right->left == NULL);    // checking node 6 children
        REQUIRE(tree.root->left->left->left->right->right == NULL);
    ...
    SECTION("verify that remove(x) successfully removes a node that is the root node") {
        std::cout<<tree.findParentOf(51)<<"->is what it returns";
        tree.remove(50);
        std::stringstream ss2;
        PrettyPrinter::printPretty(tree.root, 1, 0, ss2);
        ...
        REQUIRE(tree.root->left->right->left == NULL);                // checking node 26 children
        REQUIRE(tree.root->left->right->right == NULL);
        REQUIRE(tree.root->right->left->left == NULL);                // checking node 60 children
        REQUIRE(tree.root->right->left->right->data == 65);
        REQUIRE(tree.root->left->left->left->left->data == 1);        // checking node 5 children
        REQUIRE(tree.root->left->left->left->right->data == 6);
        REQUIRE(tree.root->right->left->right->left == NULL);         // checking node 65 children
...
TEST_CASE("testing makeEmpty() method on an empty BST", "[MAKEEMPTY]") {
    ...
    INFO("before calling makeEmpty(), BST should be empty [ root -> NULL ]");
    REQUIRE(tree.root == NULL);
    ...
    SECTION("verify that makeEmpty() doesn't break anything when BST is empty") {
        tree.makeEmpty();
        INFO("after calling makeEmpty(), BST should still be empty [ root -> NULL ]");
        REQUIRE(tree.root == NULL);
...
TEST_CASE("testing makeEmpty() method on a non-empty BST", "[MAKEEMPTY]") {
    ...
    SECTION("verify that makeEmpty() successfully empties BST and structure is correct") {
        tree.makeEmpty();
        INFO("after calling makeEmpty(), BST should be empty [ root -> NULL ]");
        REQUIRE(tree.root == NULL);
...
TEST_CASE("testing findNode(n,x) method on an empty BST", "[FINDNODE]") {
    ...
    INFO("before calling findNode(n,x), BST should be empty [ root -> NULL ]");
    REQUIRE(tree.root == NULL);
    INFO("before calling findNode(n,x), BST numNodes should be 0");
    REQUIRE(tree.numNodes == 0);

    SECTION("verify that findNode(n,x) returns NULL when BST is empty") {
        INFO("attempted to find a node containing the value 11");
        REQUIRE(tree.findNode(NULL, 11) == NULL);
    }
}
...
TEST_CASE("testing findNode(n,x) method on a non-empty BST", "[FINDNODE]") {
    ...
    SECTION("verify that findNode(root,x) returns NULL when BST does not contain x") {
        INFO("should fail to find a node containing the value 49");
        REQUIRE(tree.findNode(tree.root, 49) == NULL);
    }
    ...
    SECTION("verify that findNode(m,x) returns NULL when search starts at m and BST contains x in a higher node") {
        INFO("should fail to find a node containing the value 50 when starting from node 25");
        Node<int> *node = tree.findNode(tree.root, 25);
        REQUIRE(tree.findNode(node, 50) == NULL);
    }
}
...
TEST_CASE("testing findMinNode(n) method on an empty BST", "[FINDMINNODE]") {
    ...
    INFO("before calling findMinNode(n), BST should be empty [ root -> NULL ]");
    REQUIRE(tree.root == NULL);
    INFO("before calling findMinNode(n), BST numNodes should be 0");
    REQUIRE(tree.numNodes == 0);

    SECTION("verify that findMinNode(n) returns NULL when BST is empty") {
        REQUIRE(tree.findMinNode(NULL) == NULL);
    }
}
...
TEST_CASE("testing findMaxNode(n) method on an empty BST", "[FINDMAXNODE]") {
    ...
    INFO("before calling findMaxNode(n), BST should be empty [ root -> NULL ]");
    REQUIRE(tree.root == NULL);
    INFO("before calling findMaxNode(n), BST numNodes should be 0");
    REQUIRE(tree.numNodes == 0);

    SECTION("verify that findMaxNode(n) returns NULL when BST is empty") {
        REQUIRE(tree.findMaxNode(NULL) == NULL);
    }
}
...
TEST_CASE("testing findSuccessor(n) method on a non-empty BST", "[FINDSUCCESSOR]") {
    ...
    SECTION("verify that findSuccessor(n) returns NULL when node has no successor") {
        Node<int> *node26 = tree.findNode(tree.root, 26);
        INFO("should fail to find a successor for node 26 and return NULL");
        REQUIRE(tree.findSuccessor(node26) == NULL);
    }
...
TEST_CASE("testing findParentOf(x) method on an empty BST", "[FINDPARENTOF]") {
    ...
    INFO("before calling findParentOf(x), BST should be empty [ root -> NULL ]");
    REQUIRE(tree.root == NULL);
    INFO("before calling findParentOf(x), BST numNodes should be 0");
    REQUIRE(tree.numNodes == 0);

    SECTION("verify that findParentOf(n) returns NULL when BST is empty") {
        REQUIRE(tree.findParentOf(999) == NULL);
    }
}
...
TEST_CASE("testing findParentOf(x) method on a non-empty BST", "[FINDPARENTOF]") {
    ...
    SECTION("verify that findParentOf(x) returns NULL when search starts at root (it has no parent)") {
        INFO("should return NULL since root node has no parent");
        REQUIRE(tree.findParentOf(50) == NULL);
    }
...
TEST_CASE("testing insertNode(n,x) method on an empty BST", "[INSERTNODE]") {
    ...
    INFO("before calling insertNode(n,x), BST should be empty [ root -> NULL ]");
    REQUIRE(tree.root == NULL);
    ...
    SECTION("verify structure of BST after multiple inserts into empty BST") {
        ...
        REQUIRE(tree.root != NULL);             // checking root node
        REQUIRE(tree.root->data == 4);
        REQUIRE(tree.root->left == NULL);       // checking node 4 children
        REQUIRE(tree.root->right == NULL);
...
TEST_CASE("testing insertNode(n,x) method on a non-empty BST", "[INSERTNODE]") {
    ...
    SECTION("verify structure of BST after calling insertNode(n,x) from middle node") {
        ...
        INFO("insertNode(n,x) method should return same node that was passed in (unless NULL was passed");
        ...
        REQUIRE(tree.root->right->right->left == NULL);  // checking node 9 children
...
TEST_CASE("testing removeAllNodes(n) method on an empty BST", "[REMOVEALLNODES]") {
    ...
    INFO("before calling removeAllNodes(n), BST should be empty [ root -> NULL ]");
    REQUIRE(tree.root == NULL);
    ...
    SECTION("verify that removeAllNodes(n) doesn't break anything when BST is empty") {
        ...
        INFO("after calling removeAllNodes(n), BST should still be empty [ root -> NULL ]");
        REQUIRE(tree.root == NULL);
...
TEST_CASE("testing removeAllNodes(n) method on a non-empty BST", "[REMOVEALLNODES]") {
    ...
    SECTION("verify that removeAllNodes(n) successfully empties BST and structure is correct") {
        tree.removeAllNodes(tree.root);
        tree.root = NULL;   // if root is not set to NULL for this test case, then destructor will SEGFAULT!
